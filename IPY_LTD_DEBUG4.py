...
Used to test viability 'soft' trip
i.e. setting P=Qmax=Qmin = 0 instead of just changing status to 0 which seems
to not correctly update PSLF tables, and thus python mirror system becomes 
distorted.
"""
