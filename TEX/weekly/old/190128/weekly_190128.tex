...
\begin{document}
	...
	\begin{enumerate}
		\item Committee presentation draft completed. (for 02/05/19)
...
\paragraph{Current Tasks:}
	\begin{enumerate}
		\item Revisit Adams-Bashforth integration - current calculation may be wrong.
		\item Add simulation data export folder to simulation parameters
...
\paragraph{Future Tasks:}(Little to No Progress since last time / Things coming down the pipe)
	\begin{enumerate}
		...
		\item pgov2 $\rightarrow$ account for multiple governors, use $\beta$ (area frequency response characteristic) in place of R (machine droop)
