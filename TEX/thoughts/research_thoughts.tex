...
\chead{Long Term Dynamic Simulation Thoughts \\ January 11, 2019}
\lhead{Research \\ }
% spacing
\headheight 29 pt
\headsep 6 pt
...
\begin{document}
	...
	\begin{enumerate}
		...
		\subitem End result: .mat output. Requires 'Pickeling' object from ironpython to python 3 where scipy is used to export a .mat file. An algorithm that will compile python data into a dictionary must be written.
