...
if test_case == 0:
    ...
    # Will no longer run due to multi area slack issues / parsing issues
...
# Pertrubances configured for test case: miniWecc
# single step down - absolute
#mir.addPert('Load',[73],'Step',['P',2,7500]) # quick 600 MW step in colorado
#mir.addPert('Load',[70],'Step',['P',2,5000]) # quick 850 MW step in colorado

# single step down - relative
mir.addPert('Load',[73],'Step',['P',2,-600,'rel']) # quick 600 MW step in colorado
mir.addPert('Load',[70],'Step',['P',2,-850,'rel']) # quick 850 MW step in colorado
