def dispSimTandC(mir):
    ...
    print('{:>28}'.format("Uncounted PY3 Time:") , '{:12f}'.format(mir.SimTime-mir.DynamicTime-mir.PY3SendTime-mir.PY3RecTime))
    print('{:>28}'.format("Uncounted IPY Time:") , '{:12f}'.format(mir.PY3RecTime-mir.PFTime-mir.IPYSendTime-mir.IPYdistPaccTime-mir.IPYPvalsTime-mir.IPYmsgMake))
