...
class tgov1Agent():
    ...
    def stepDynamics(self):
        ...
        uVector = dwVec/self.R#*self.mirror.Sbase
        ...
        _, y2, self.x2 = sig.lsim(self.sys2, y1, T=self.t, 
                                   X0=self.r_x2[self.mirror.c_dp-1]) #self.Gen.r_Pm[self.mirror.c_dp-1]) # this initial value should be okay...
        ...
        posNewPm = float(Pmech[1])*self.mwCap + self.Gen.Pm
    ...
    def initRunningVals(self):
        ...
        self.r_x1.append(0.0) #self.Gen.Pm)
        self.r_x2.append(0.0) #self.Gen.Pm)
