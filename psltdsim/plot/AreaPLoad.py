def AreaPLoad(mirror, blkFlag=True, printFigs=False, miniFlag = False):
    """Plot P load of given mirror by area"""
    ...
    for area in mir.Area:
        ax.plot(mins, area.r_P, linewidth=.85, label = 'Area '+str(area.Area))
    ...
    fig.tight_layout()
    if printFigs: plt.savefig(caseName+'AreaPload'+'.pdf', dpi=300)
