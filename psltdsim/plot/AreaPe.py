def AreaPe(mirror, blkFlag=True, printFigs=False, miniFlag = False):
    """Plot Pe of given mirror by area"""
    ...
    for area in mir.Area:
        ax.plot(mins, area.r_Pe, linewidth=.85, label = 'Area '+str(area.Area))
    ...
    ax.set_title('Area Electric Power Output')
    ...
    fig.tight_layout()
    if printFigs: plt.savefig(caseName+'AreaPe'+'.pdf', dpi=300)
