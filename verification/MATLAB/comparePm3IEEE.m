function [  ] = comparePm3IEEE( mir, psds_data, varargin )
...
grid on
%if noCase ==1
        title('Percent Difference of Mechanical Power Output')
%    else
%        title({'Percent Difference of LTD and PSDS Mechanical Power Outputs'; ['Case: ', LTDCaseName]})
%    end
...
if printFigs
    ...
    export_fig([LTDCaseName,'Pm3'],'-pdf'); % to print fig
end
%% end of function
end
