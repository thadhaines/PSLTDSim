function [  ] = comparePbr3ALT( mir, psds_data, varargin )
...
grid on
if noCase ==1
    title('Branch Real Power Flow Percent Difference')
else
    title({'Branch Real Power Flow Percent Difference'; ['Case: ', LTDCaseName]})
end
xlabel('Time [sec]')
...
if printFigs
    ...
    export_fig([LTDCaseName,'Pbr3ALT'],'-pdf'); % to print fig
end
%% end of function
end
