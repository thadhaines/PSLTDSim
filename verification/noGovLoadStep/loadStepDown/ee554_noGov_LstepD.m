...
%   01/24/19    19:32   Split into LstepD
...
% LTD data
stairs(t_1,noGovStepDE.A1.S011.S0.Pe,':o','linewidth',1.5,'color',pltC.magenta)
stairs(t_1,noGovStepDE.A1.G021.G0.Pe,':s','linewidth',1,'color',pltC.dgreen)
...
plot(noGovStepDAB.t,noGovStepDAB.f,':s','linewidth',1.5,'color',pltC.green)
plot(noGovStepDEw.t,noGovStepDEw.f,':+','linewidth',1.5,'color',[0,0,0])
plot(noGovStepDABw.t,noGovStepDABw.f,':+','linewidth',1.5,'color',pltC.Lblue)
...
%LTD data
stairs(t_1,noGovStepDE.A1.S011.Vm,':o','linewidth',1.5,'color',pltC.magenta)
stairs(t_1,noGovStepDE.A1.G021.Vm,':s','linewidth',1,'color',pltC.dgreen)
...
stairs(t_1,noGovStepDE.A1.S011.S0.Q,':o','linewidth',1.5,'color',pltC.magenta)
stairs(t_1,noGovStepDE.A1.G021.G0.Q,':s','linewidth',1,'color',pltC.dgreen)
