/* Open .sav file */
@ret = getf("C:\LTD\pslf_systems\miniWECC\miniWECC3AreaLTDPSS.sav")

/* MAKE SURE BASE CASE IS SOLVED. */
@ret = soln()

/* READ THE DYNAMIC DATA. */
@ret = rdyd("C:\LTD\pslf_systems\miniWECC\miniWECC_LTD_PSS.dyd","",1)

/* INIT THE DYNAMIC DATA AND SET THE CHANNEL FILE. */
@ret = init("C:\LTD\pslf_systems\miniWECC\PSLFres\miniWECC_loadRampPSS.chf", "C:\LTD\pslf_systems\miniWECC\PSLFres\miniWECC_loadRampPSS.rep", 0, 1, "C:\LTD\inrun\mwr1.p", "", 0)
dypar[0].nplot   = 1     
