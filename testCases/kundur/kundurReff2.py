...
simNotes = """
Ramp of load down 5% over 40 seconds.
"""
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\kundurReff\\", # relative path from cwd
    'fileName' : 'kundurReff2',
...
dydPath = [r"C:\LTD\pslf_systems\kundur4LTD\kundur4LTDsameGens3.dyd"]
