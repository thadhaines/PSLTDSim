...
Loads manipulated to follow windramp but with added noise
...
Shunts are configured to keep bus 8 and 9 Voltage between 1 and 1.03 PU
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\200202-windramp\\", # relative path from cwd
    'fileName' : 'sixMachineWindramp',
...
ltdPath = r".\testCases\200202-windramp\sixMachineWindramp.ltd.py"