...
@ret = rdyd("C:\LTD\pslf_systems\MiniPSLF_PST\miniWECC_LTD.dyd","",1)

/* INIT THE DYNAMIC DATA AND SET THE CHANNEL FILE. */
@ret = init("C:\LTD\pslf_systems\MiniPSLF_PST\PSLFres\miniWECC_genTrip032.chf", "C:\LTD\pslf_systems\eele554\PSLFres\miniWECC_genTrip032.rep", 0, 1, "", "", 0)
dypar[0].nplot   = 1     
