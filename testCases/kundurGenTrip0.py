...
simParams = {
    ...
    'fileDirectory' : "\\delme\\kundurGenTrip\\", # relative path from cwd
    'fileName' : 'kundurGenTrip0',
...
ltdPath = [r"C:\LTD\pslf_systems\kundur4LTD\kundur.GenTrip.ltd"]