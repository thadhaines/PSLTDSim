...
simNotes = """
Alt Base case: with AGC
Delay over response test on mini WECC scale
Step gen 45 pgen, pm  in area 3 -200 MW at t=2
"""
...
simParams = {
    ...
    'fileName' : 'miniWECCDelayStep3AGC',
...
ltdPath = r".\testCases\200123-miniWECCdelay\miniWECCDelayStep3AGC.ltd.py"