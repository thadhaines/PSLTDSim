...
simNotes = """
Step of load up 10%. AGC using TLB 2, meet ten minute zero ace of NERC criterion
"""
...
ltdPath = r".\testCases\sixMachine\sixMachineStepBA4.ltd.py"