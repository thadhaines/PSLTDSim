...
simNotes = """
Ramp of load up 10% over 40 seconds. Reff used
"""
...
simParams = {
    ...
    'Dsys' : 0.0, # Untested 
    'ReffEnable' : True, # Account for Governor R being affected by non-gov %
...
ltdPath = [r"C:\LTD\pslf_systems\sixMachine\sixMachineRamp.ltd"]