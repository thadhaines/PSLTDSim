...
simNotes = """
Bringing Gen 5 (90 MW) on at t = 2
"""
...
savPath = r"C:\LTD\pslf_systems\sixMachine\sixMachineTripped.sav"
dydPath = [r"C:\LTD\pslf_systems\sixMachine\sixMachine2.dyd"]
ltdPath = r".\testCases\sixMachine\sixMachineTrip1.ltd.py"