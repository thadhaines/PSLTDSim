...
simNotes = """
agc with deadband and nz, area 2 perturbance TLB 0, external pertrubance
"""
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\200325-smFinal\\", # relative path from cwd
    'fileName' : 'smAGCt0Ex1',
...
ltdPath = r".\testCases\200325-smFinals\smAGCt0Ex1.ltd.py"