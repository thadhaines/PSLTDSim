...
simNotes = """
Test system / scenario for inertia perturbances
"""
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\200203-Hpert\\", # relative path from cwd
    'fileName' : 'sixMachineHpert',
...
ltdPath = r".\testCases\200203-pertrubH\sixMachineHpert.ltd.py"