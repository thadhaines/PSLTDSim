...
@ret = rdyd("C:\LTD\pslf_systems\miniWECC\miniWECC_LTD.dyd","",1)

/* INIT THE DYNAMIC DATA AND SET THE CHANNEL FILE. */
@ret = init("C:\LTD\pslf_systems\miniWECC\PSLFres\miniWECC_loadRamp.chf", "C:\LTD\pslf_systems\miniWECC\PSLFres\miniWECC_loadRamp.rep", 0, 1, "C:\LTD\inrun\mwr1.p", "", 0)
dypar[0].nplot   = 1     
