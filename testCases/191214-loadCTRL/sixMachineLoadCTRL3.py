...
simNotes = """
Testing of Load controller - with noise - and step
"""
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\sixMachineLoadCTRL\\", # relative path from cwd
    'fileName' : 'SixMachineLoadCTRL3',
...
ltdPath = r".\testCases\191214-loadCTRL\sixMachineLoadCTRL3.ltd.py"