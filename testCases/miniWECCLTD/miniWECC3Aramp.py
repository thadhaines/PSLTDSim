...
simNotes = """
MiniWECC Multi Area ramp of 1200 MW at t=2 to t=42
"""
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\miniWECC3ALTD\\", # relative path from cwd
    'fileName' : 'miniWECC3ALTDramp',
...
ltdPath = r".\testCases\miniWECCLTD\miniWECCRamp.ltd.py"