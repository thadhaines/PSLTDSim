...
simNotes = """
Testing of Generation control Agent
"""
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\sixMachineGenCTRL\\", # relative path from cwd
    'fileName' : 'SixMachineGenCTRL',
...
ltdPath = r".\testCases\191215-genCTRL\sixMachineGenCTRL.ltd.py"