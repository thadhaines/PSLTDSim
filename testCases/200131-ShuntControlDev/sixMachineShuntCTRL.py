...
simNotes = """
Basic Scenario to test Shunt Control Agent
i.e. Low voltage (<0.95) from load step at t = 2
"""
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\200131-ShuntControlDev\\", # relative path from cwd
    'fileName' : 'sixMachineShuntCTRL',
...
ltdPath = r".\testCases\200131-ShuntControlDev\sixMachineShuntCTRL.ltd.py"