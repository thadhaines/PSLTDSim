...
simNotes = """
generic MiniWECC trip of gen bus 27 at t=2, 
"""
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\genMW\\", # relative path from cwd
    'fileName' : 'genMWgenTrip027',
...
dydPath = [r"C:\LTD\pslf_systems\miniWECC\miniWECC_LTDgenerics.dyd"]
ltdPath = r".\testCases\191118-miniWECCgeneric\miniWECCgenTrip0.ltd.py"