...
CTRLtimeScale = 60*60 # hours

# Perturbances
mirror.sysPerturbances = [
    # ramp non-gov gens
    'gen 2 2 : ramp Pm 300 2700 150 rel', # 45 min ramp up
    'gen 2 2 : ramp Pm 4200 2700 -150 rel', # 45 min ramp down
    'gen 5 : ramp Pm 300 2700 300 rel', # 45 min ramp up
    'gen 5 : ramp Pm 4200 2700 -300 rel', # 45 min ramp down
    ]
...
mirror.sysBA = {
    'BA1':{
        ...
        'GovDeadbandType' : 'none',#nldroop', # step, None, ramp, nldroop
        'GovDeadband' : .036, # Hz
    ...
    'bus9caps' : {
        ...
        'Timers' : {
            'set' :{ # set shunts
                ...
                'actTime' : 45, # seconds of true logic before act
                'act' : "anyOFFTar = 1", # set any target off target = 1
            },# end set
            'reset' :{ # reset shunts
