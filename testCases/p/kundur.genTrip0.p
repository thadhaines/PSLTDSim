...
@ret = init("C:\LTD\pslf_systems\kundur4LTD\results\kundur.gentrip0.chf", "C:\LTD\pslf_systems\kundur4LTD\results\kundur.gentrip0.rep", 0, 1, "", "", 0)
dypar[0].nplot   = 1     
dypar[0].nscreen = 5   
...
@trip = rec_index(1,3,4,-1,"**",0,0)
if (@trip<0)
logterm("Error in tripping generator")
else
logterm("Tripped generator successfully")
endif
