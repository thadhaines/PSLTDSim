...
@ret = rdyd("C:\LTD\pslf_systems\kundur4LTD\kundur4LTDsameGens3.dyd","",1)

/* INIT THE DYNAMIC DATA AND SET THE CHANNEL FILE. */
@ret = init("C:\LTD\pslf_systems\kundur4LTD\results\kundur.rampReff2.chf", "C:\LTD\pslf_systems\kundur4LTD\results\kundur.rampReff2.rep", 0, 1, "C:\LTD\inrun\kr0.p", "", 0)
dypar[0].nplot   = 1     
dypar[0].nscreen = 2400   
