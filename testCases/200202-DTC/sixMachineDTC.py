...
simNotes = """
Test system / scenario to test Definite Time Controller
"""
...
simParams = {
    ...
    'fileDirectory' : "\\delme\\200202-DTC\\", # relative path from cwd
    'fileName' : 'sixMachineDTC',
...
ltdPath = r".\testCases\200202-DTC\sixMachineDTC.ltd.py"